    ...
    <Box component="footer" mt={32}>
      <Container>
        <Text ta="center" fz={14} c="gray.5">
          ...
          <Anchor href="https://github.com/tatthien/clickup-time-tracking" target="_blank" c="gray.5" fz={14}>
            GitHub
          </Anchor>
          <Text span px={6} c="gray.4">
            /
          </Text>
          <Anchor href="https://www.buymeacoffee.com/tatthien" target="_blank" c="gray.5" fz={14}>
            Coffee
          </Anchor>
          <Text span px={6} c="gray.4">
            /
