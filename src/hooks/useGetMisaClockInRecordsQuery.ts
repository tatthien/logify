...
const fetchMisaClockInRecords = async (params: { start: string; end: string; sessionId: string }) => {
...
export function useGetMisaClockInRecordsQuery(params: { start: string; end: string; sessionId: string }) {
  return useQuery({
